...
it calls the functions Whitescreen16bpp
   and drawblueblock16bpp
...
Win:
    ...
    //Draw G
    push    {lr}                            //save lr
    bl      Drawblueblock16bpp                  //branch to function Drawbloack
    pop     {lr}                            //restore lr
    add     r1, #16                         //add 16 pixels to x
    push    {lr}                            //save lr
    bl      Drawblueblock16bpp                  //branch function Drawblueblock
    pop     {lr}                            //restore lr
    add     r1, #16                         //add 16 pixels to x
    push    {lr}                            //save lr
    bl      Drawblueblock16bpp                  //branch to function Drawbloack
    ...
    push    {lr}                            //save lr
    bl      Drawblueblock16bpp                  //call Drawblueblock16bpp
    pop     {lr}                            //restore lr
